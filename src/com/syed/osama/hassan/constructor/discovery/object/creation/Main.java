package com.syed.osama.hassan.constructor.discovery.object.creation;
...
public class Main {
    ...
    public static void main(String[] args) throws InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        Address address = createInstanceWithArguments(Address.class, "Harley", 2);
        Person person = createInstanceWithArguments(Person.class, address, "John", 22);
    ...
    public static <T> T createInstanceWithArguments(Class<T> clazz, Object ... args) throws InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        System.out.println("Appropriate constructor was not found");
        return null;
    }
